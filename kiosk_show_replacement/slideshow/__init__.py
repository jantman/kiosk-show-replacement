...
def create_slideshow():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect(url_for('slideshow.edit_slideshow', slideshow_id=slideshow.id))
...
def edit_slideshow(slideshow_id):
    ...
    slides = SlideItem.query.filter_by(slideshow_id=slideshow_id).order_by(SlideItem.order_index).all()
