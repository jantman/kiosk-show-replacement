...
from flask_migrate import upgrade, downgrade, migrate, init, current, show, stamp
...
class MigrationUtils:
    ...
    def stamp_database(revision: str) -> bool:
        ...
        try:
            ...
            current_app.logger.error(f"Error stamping database with revision {revision}: {e}")
            return False
